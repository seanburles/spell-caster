        ...
        <div className="flex flex-col items-center gap-4">
            ...
            >
                ...
                >
                    ...
                    >
                        <div className="w-full h-full bg-gradient-to-br from-indigo-900/40 to-purple-900/40 rounded-2xl border-2 border-indigo-500/50 p-6 flex flex-col">
                            <div className="text-center mb-4">
                                <p className="text-xs text-indigo-300 uppercase tracking-wider mb-1">{card1.role}</p>
                                <h4 className="text-2xl font-serif text-amber-300 mb-1">{card1.name}</h4>
                            ...
                            {card1.imageUrl && (
                                <div className="flex-1 flex items-center justify-center mb-4">
                                    <img
                                        src={card1.imageUrl}
                                        alt={card1.name}
                                        className="max-h-80 rounded-xl shadow-2xl border border-indigo-500/30"
                                    />
                                </div>
                            )}
                    ...
                    >
                        <div className="w-full h-full bg-gradient-to-br from-purple-900/40 to-pink-900/40 rounded-2xl border-2 border-purple-500/50 p-6 flex flex-col">
                            <div className="text-center mb-4">
                                <p className="text-xs text-purple-300 uppercase tracking-wider mb-1">{card2.role}</p>
                                <h4 className="text-2xl font-serif text-amber-300 mb-1">{card2.name}</h4>
                            ...
                            {card2.imageUrl && (
                                <div className="flex-1 flex items-center justify-center mb-4">
                                    <img
                                        src={card2.imageUrl}
                                        alt={card2.name}
                                        className="max-h-80 rounded-xl shadow-2xl border border-purple-500/30"
                                    />
                                </div>
                            )}
            ...
            <div className="flex gap-3 w-full max-w-md">
                <button
                    ...
                    className="flex-1 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg font-medium text-sm transition-all flex items-center justify-center gap-2"
                >
                            ...
                            {ritualResult.sigil?.imageUrl && (
                                <div className="flex justify-center mb-6">
                                    <img
                                        ...
                                        className="w-32 h-32 rounded-full border-2 border-amber-500/50 shadow-2xl"
                                    />
                                </div>
                            )}
                            <h2 className="text-4xl font-serif font-medium text-amber-400 mb-2">{ritualResult.ritual?.title}</h2>
                        ...
                        <div className="space-y-6">
                            ...
                            {ritualResult.ritual?.timing && (
                                <div className="bg-gradient-to-br from-indigo-900/30 to-purple-900/30 p-6 rounded-xl border border-indigo-500/30">
                                    <h3 className="text-2xl font-serif text-indigo-300 mb-4 flex items-center gap-2">
                                        🌙 Optimal Timing
                                    </h3>
                                    <div className="grid md:grid-cols-2 gap-4 text-slate-200">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-medium text-rose-300">{ritualResult.ritual.timing.whatNotToDo}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                                <h3 className="text-2xl font-serif text-purple-300 mb-4">✨ The Ritual</h3>
                                ...
                                {ritualResult.ritual?.physicalAction && (
                                    <div className="mt-4 p-4 bg-amber-900/20 rounded-lg border-l-4 border-amber-500">
                                        <p className="text-sm text-amber-200 font-medium mb-1">Physical Action:</p>
                            ...
                            <div className="bg-gradient-to-r from-amber-900/30 to-orange-900/30 p-8 rounded-xl border border-amber-500/30">
                                <h3 className="text-xl font-serif text-amber-300 mb-4 text-center">Your Mantra</h3>
                                <p className="text-3xl font-medium text-center italic text-amber-100 leading-relaxed">
                            ...
                            {ritualResult.ritual?.correspondences && (
                                <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                                    <h3 className="text-2xl font-serif text-emerald-300 mb-4">💎 Sacred Correspondences</h3>
                            ...
                            {ritualResult.tarot?.card1 && ritualResult.tarot?.card2 && (
                                <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                                    <h3 className="text-2xl font-serif text-indigo-300 mb-4 text-center">🔮 Your Tarot Guidance</h3>
                            ...
                            {ritualResult.astrology && (
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                                        <h3 className="text-xl font-serif text-cyan-300 mb-3">🪐 Transit Influence</h3>
                                        <p className="text-base text-slate-300 leading-relaxed">{ritualResult.astrology.transitInfluence}</p>
                                    </div>
                                    <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                                        <h3 className="text-xl font-serif text-teal-300 mb-3">🌬️ Elemental Energy</h3>
                            ...
                            {ritualResult.shadowWork && (
                                <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-700">
                                    <h3 className="text-2xl font-serif text-violet-300 mb-4">🧿 Shadow & Light</h3>
                            ...
                            {ritualResult.horoscope && (
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                                        <h3 className="text-xl font-serif text-rose-300 mb-3">☀️ Daily Guidance</h3>
                                        <p className="text-base text-slate-300 leading-relaxed">{ritualResult.horoscope.daily}</p>
                                    </div>
                                    <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                                        <h3 className="text-xl font-serif text-pink-300 mb-3">🌙 Monthly Outlook</h3>
                            ...
                            {ritualResult.soulCity && (
                                <div className="bg-gradient-to-br from-teal-900/30 to-cyan-900/30 p-6 rounded-xl border border-teal-500/30">
                                    <h3 className="text-2xl font-serif text-teal-300 mb-4 text-center">🌍 Your Soul City</h3>

                                    <div className="text-center mb-6">
                                        <h4 className="text-3xl font-serif text-amber-300 mb-2">
                                            {ritualResult.soulCity.city}, {ritualResult.soulCity.country}
                                        </h4>
                                        <div className="flex items-center justify-center gap-3 mb-3">
                                            <span className="px-3 py-1 rounded-full bg-teal-800/50 border border-teal-500/50 text-xs text-teal-200 uppercase tracking-wider">
                                                {ritualResult.soulCity.energyType}
                                            </span>
                                            <span className="px-3 py-1 rounded-full bg-cyan-800/50 border border-cyan-500/50 text-xs text-cyan-200 uppercase tracking-wider">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-4">
                                            <div className="bg-slate-900/30 p-4 rounded-lg">
                                                <p className="text-xs text-teal-300 uppercase tracking-wider mb-2">Also Aligned Cities</p>
                                                <p className="text-sm text-slate-300">{ritualResult.soulCity.altCities.join(", ")}</p>
                                            </div>
                                            <div className="bg-slate-900/30 p-4 rounded-lg">
                                                <p className="text-xs text-rose-300 uppercase tracking-wider mb-2">Regions to Be Mindful Of</p>
                                                <p className="text-sm text-slate-300">{ritualResult.soulCity.avoidRegions.join(", ")}</p>
                                            </div>
                                        </div>

                                        <div className="text-center pt-4 border-t border-teal-500/30">
                            ...
                            {ritualResult.reflection && (
                                <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 p-6 rounded-xl border border-purple-500/30">
                                    <h3 className="text-2xl font-serif text-purple-300 mb-4">🪞 Reflection</h3>
                                    <div className="space-y-4">
                                        <div>
                                            <p className="text-sm text-purple-200 mb-2 font-medium">Journal Prompt:</p>
                                            <p className="text-lg text-slate-200 italic">{ritualResult.reflection.journalPrompt}</p>
                                        </div>
                                        <div className="pt-4 border-t border-purple-500/30">
                                            <p className="text-xl text-center font-medium text-amber-200 italic">
                    ...
                    >
                        <div className="bg-mystic-glass border border-mystic w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden pointer-events-auto flex flex-col max-h-[90vh] text-mystic-bright">
                            ...
                            <div className="flex items-center justify-between p-8 border-b border-white/10">
                                <div>
                                    <h2 className="text-3xl font-serif font-medium text-amber-400/90">{STEPS[currentStep].title}</h2>
                                    ...
                                    {currentStep === 0 && (
                                        ...
                                        >
                                            <div>
                                                ...
                                                <input
                                                    {...register("name")}
                                                    className="w-full p-4 rounded-xl border border-slate-600 bg-white/5 focus:ring-2 focus:ring-amber-500/50 outline-none text-lg placeholder:text-slate-500 transition-all hover:bg-white/10"
                                    ...
                                    {currentStep === 2 && (
                                        ...
                                        >
                                            <div>
                                                ...
                                                <select
                                                    {...register("spellType")}
                                                    className="w-full p-4 rounded-xl border border-slate-600 bg-white/5 focus:ring-2 focus:ring-amber-500/50 outline-none text-lg text-slate-200 transition-all hover:bg-white/10"
                                                >
                            ...
                            <div className="p-8 border-t border-white/10 bg-white/5 flex justify-between">
                                ...
                                {currentStep < STEPS.length - 1 ? (
                                    ...
                                    <button
                                        ...
                                        className="flex items-center px-6 py-2 rounded-full bg-indigo-600 text-white font-medium hover:bg-indigo-700 transition-colors disabled:opacity-50"
                                    >
                                        {isSubmitting ? (
                                            <>
                                                <Loader2 className="w-4 h-4 mr-2 animate-spin" /> Generating Ritual...
                                            </>
                                        ) : (
                                            "Generate Ritual"
                                        )}
